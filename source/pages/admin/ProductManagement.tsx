        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-3xl shadow-sm border border-surface-200">
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Imagem de Capa (Recomendado: 1024x768 ou 1024x800 - Proporção 4:3)</label>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    {coverUrl && (
                                        <div className="h-12 w-16 rounded-lg overflow-hidden border border-surface-200 shadow-sm">
